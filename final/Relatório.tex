...
requisitado pelo sistema o correio eletrónico e a palavra passe da conta do utilizador, como podemos
observar na figura abaixo. Estamos a demonstrar a primeira tentativa de execução da aplicação, onde
ainda não existem alunos registados, pelo que efetuamos o primeiro início de sessão como diretor de
curso. \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{Imagens/Manual/DiretorCurso.png}

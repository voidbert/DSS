...
\begin{usecase}
    ...
    \flow{
        ...
        \item Sistema pede informação sobre o aluno: número de aluno, nome, endereço eletrónico, e a
            sua média de curso (se aplicável).
...
\begin{usecase}
    ...
    \flow{
        ...
        \item Sistema verifica que o horário do aluno inclui exatamente os turnos que o aluno deve
            frequentar.
